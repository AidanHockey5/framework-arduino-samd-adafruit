...
const PinDescription g_APinDescription[]=
{
  ...
  { PORTB, 5, PIO_DIGITAL, PIN_ATTR_DIGITAL, ADC_Channel7, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },  // 49, PREV_BTN PB04
  { PORTB, 23, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM , TC7_CH1, EXTERNAL_INT_7 },  // 50, YM_IRQ
} ;
