...
const PinDescription g_APinDescription[]=
{
  ...
  //Page 32
  //Custom Digital Pins
  { PORTB, 0, PIO_DIGITAL, PIN_ATTR_DIGITAL, ADC_Channel12, NOT_ON_PWM, TC7_CH0, EXTERNAL_INT_0 },      // 47, PREV_BTN PB00
  { PORTB, 1, PIO_DIGITAL, PIN_ATTR_DIGITAL, ADC_Channel12, NOT_ON_PWM, TC7_CH0, EXTERNAL_INT_1 },      // 48, RAND_BTN PB01
  { PORTB, 4, PIO_DIGITAL, PIN_ATTR_DIGITAL, ADC_Channel6, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },  // 49, NEXT_BTN PB04
  { PORTB, 5, PIO_DIGITAL, PIN_ATTR_DIGITAL, ADC_Channel7, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },  // 50, PREV_BTN PB04
  { PORTB, 23, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM , TC7_CH1, EXTERNAL_INT_7 }  // 51, YM_IRQ
} ;
